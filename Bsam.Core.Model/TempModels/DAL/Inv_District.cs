...
namespace Bsam.Core.Model.Models.DAL
{
	...
	public partial class Inv_District
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Bsam.Core.Model.Models.Model.Inv_District model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Inv_District(");
			strSql.Append("Id,DistrictCode,DistrictName,DistrictDesc,DistrictStatus,Volume,VolumeUnit,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId,InvId)");
			strSql.Append(" values (");
			strSql.Append("@Id,@DistrictCode,@DistrictName,@DistrictDesc,@DistrictStatus,@Volume,@VolumeUnit,@DateTimeCreated,@UserCreator,@DateTimeModified,@UserModified,@State,@OrgId,@InvId)");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@Id", DbType.Int32,8),
					new SQLiteParameter("@DistrictCode", DbType.String,0),
					new SQLiteParameter("@DistrictName", DbType.String,0),
					new SQLiteParameter("@DistrictDesc", DbType.String,0),
					new SQLiteParameter("@DistrictStatus", DbType.String,0),
			...
			parameters[1].Value = model.DistrictCode;
			parameters[2].Value = model.DistrictName;
			parameters[3].Value = model.DistrictDesc;
			parameters[4].Value = model.DistrictStatus;
			parameters[5].Value = model.Volume;
			parameters[6].Value = model.VolumeUnit;
			...
			parameters[13].Value = model.InvId;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Bsam.Core.Model.Models.Model.Inv_District model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Inv_District set ");
			strSql.Append("Id=@Id,");
			strSql.Append("DistrictCode=@DistrictCode,");
			strSql.Append("DistrictName=@DistrictName,");
			strSql.Append("DistrictDesc=@DistrictDesc,");
			strSql.Append("DistrictStatus=@DistrictStatus,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Inv_District ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Inv_District GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,DistrictCode,DistrictName,DistrictDesc,DistrictStatus,Volume,VolumeUnit,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId,InvId from Inv_District ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Inv_District DataRowToModel(DataRow row)
		{
			Bsam.Core.Model.Models.Model.Inv_District model=new Bsam.Core.Model.Models.Model.Inv_District();
			if (row != null)
			{
				...
				if(row["DistrictCode"]!=null)
				{
					model.DistrictCode=row["DistrictCode"].ToString();
				}
				if(row["DistrictName"]!=null)
				{
					model.DistrictName=row["DistrictName"].ToString();
				}
				if(row["DistrictDesc"]!=null)
				{
					model.DistrictDesc=row["DistrictDesc"].ToString();
				}
				if(row["DistrictStatus"]!=null)
				{
					model.DistrictStatus=row["DistrictStatus"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,DistrictCode,DistrictName,DistrictDesc,DistrictStatus,Volume,VolumeUnit,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId,InvId ");
			strSql.Append(" FROM Inv_District ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Inv_District ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Inv_District T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Inv_District";
