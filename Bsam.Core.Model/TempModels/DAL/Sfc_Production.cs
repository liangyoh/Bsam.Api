...
namespace Bsam.Core.Model.Models.DAL
{
	...
	public partial class Sfc_Production
	{
		...
		public bool Add(Bsam.Core.Model.Models.Model.Sfc_Production model)
		{
			...
			strSql.Append("insert into Sfc_Production(");
			strSql.Append("Id,ProductCode,ProductName,ProductDesc,ModelType,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId)");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sfc_Production ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		public Bsam.Core.Model.Models.Model.Sfc_Production GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,ProductCode,ProductName,ProductDesc,ModelType,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId from Sfc_Production ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Sfc_Production DataRowToModel(DataRow row)
		{
			Bsam.Core.Model.Models.Model.Sfc_Production model=new Bsam.Core.Model.Models.Model.Sfc_Production();
			if (row != null)
			{
				...
				if(row["ProductDesc"]!=null)
				{
					model.ProductDesc=row["ProductDesc"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,ProductCode,ProductName,ProductDesc,ModelType,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId ");
			strSql.Append(" FROM Sfc_Production ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Sfc_Production ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sfc_Production T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Sfc_Production";
