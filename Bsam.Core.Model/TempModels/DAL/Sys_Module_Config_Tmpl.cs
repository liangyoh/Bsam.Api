...
namespace Bsam.Core.Model.Models.DAL
{
	...
	public partial class Sys_Module_Config_Tmpl
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Sys_Module_Config_Tmpl(");
			strSql.Append("Id,ModuleType,ModuleConfig,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State)");
			...
			parameters[2].Value = model.ModuleConfig;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_Module_Config_Tmpl set ");
			strSql.Append("Id=@Id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_Module_Config_Tmpl ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,ModuleType,ModuleConfig,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State from Sys_Module_Config_Tmpl ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};

			Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl model=new Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl();
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl DataRowToModel(DataRow row)
		{
			Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl model=new Bsam.Core.Model.Models.Model.Sys_Module_Config_Tmpl();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,ModuleType,ModuleConfig,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State ");
			strSql.Append(" FROM Sys_Module_Config_Tmpl ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Sys_Module_Config_Tmpl ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sys_Module_Config_Tmpl T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Sys_Module_Config_Tmpl";
