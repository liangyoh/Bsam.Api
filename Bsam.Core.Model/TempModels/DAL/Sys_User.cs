...
namespace Bsam.Core.Model.Models.DAL
{
	...
	public partial class Sys_User
	{
		...
		public bool Add(Bsam.Core.Model.Models.Model.Sys_User model)
		{
			...
			strSql.Append("Id,UserName,UserAccount,UserPwd,Address,Phone,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State)");
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Sys_User DataRowToModel(DataRow row)
		{
			Bsam.Core.Model.Models.Model.Sys_User model=new Bsam.Core.Model.Models.Model.Sys_User();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserName,UserAccount,UserPwd,Address,Phone,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State ");
