...
namespace Bsam.Core.Model.Models.DAL
{
	...
	public partial class Sys_User_In_Group
	{
		...
		public bool Add(Bsam.Core.Model.Models.Model.Sys_User_In_Group model)
		{
			...
			strSql.Append("insert into Sys_User_In_Group(");
			strSql.Append("UserId,UserGroupId)");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_User_In_Group ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UserId,UserGroupId ");
			strSql.Append(" FROM Sys_User_In_Group ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Sys_User_In_Group ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sys_User_In_Group T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Sys_User_In_Group";
