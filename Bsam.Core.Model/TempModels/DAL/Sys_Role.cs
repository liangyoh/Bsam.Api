...
namespace Bsam.Core.Model.Models.DAL
{
	...
	public partial class Sys_Role
	{
		...
		public bool Add(Bsam.Core.Model.Models.Model.Sys_Role model)
		{
			...
			strSql.Append("Id,RoleName,RoleDesc,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId)");
			strSql.Append(" values (");
			strSql.Append("@Id,@RoleName,@RoleDesc,@DateTimeCreated,@UserCreator,@DateTimeModified,@UserModified,@State,@OrgId)");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@Id", DbType.Int32,4),
					new SQLiteParameter("@RoleName", DbType.String,0),
					new SQLiteParameter("@RoleDesc", DbType.String,0),
		...
		public Bsam.Core.Model.Models.Model.Sys_Role GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,RoleName,RoleDesc,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId from Sys_Role ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Sys_Role DataRowToModel(DataRow row)
		{
			Bsam.Core.Model.Models.Model.Sys_Role model=new Bsam.Core.Model.Models.Model.Sys_Role();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,RoleName,RoleDesc,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId ");
