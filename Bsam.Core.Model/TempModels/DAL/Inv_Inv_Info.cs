...
namespace Bsam.Core.Model.Models.DAL
{
	...
	public partial class Inv_Inv_Info
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Bsam.Core.Model.Models.Model.Inv_Inv_Info model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Inv_Inv_Info(");
			strSql.Append("Id,InvCode,InvName,InvDesc,InvAddress,Volume,VolumeUnit,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId)");
			...
			SQLiteParameter[] parameters = {
					...
					new SQLiteParameter("@InvDesc", DbType.String,0),
			...
			parameters[1].Value = model.InvCode;
			parameters[2].Value = model.InvName;
			parameters[3].Value = model.InvDesc;
			parameters[4].Value = model.InvAddress;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Bsam.Core.Model.Models.Model.Inv_Inv_Info model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Inv_Inv_Info set ");
			strSql.Append("Id=@Id,");
			strSql.Append("InvCode=@InvCode,");
			strSql.Append("InvName=@InvName,");
			strSql.Append("InvDesc=@InvDesc,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Inv_Inv_Info ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Inv_Inv_Info GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,InvCode,InvName,InvDesc,InvAddress,Volume,VolumeUnit,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId from Inv_Inv_Info ");
			strSql.Append(" where ");
			SQLiteParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Bsam.Core.Model.Models.Model.Inv_Inv_Info DataRowToModel(DataRow row)
		{
			Bsam.Core.Model.Models.Model.Inv_Inv_Info model=new Bsam.Core.Model.Models.Model.Inv_Inv_Info();
			if (row != null)
			{
				...
				if(row["InvDesc"]!=null)
				{
					model.InvDesc=row["InvDesc"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,InvCode,InvName,InvDesc,InvAddress,Volume,VolumeUnit,DateTimeCreated,UserCreator,DateTimeModified,UserModified,State,OrgId ");
			strSql.Append(" FROM Inv_Inv_Info ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Inv_Inv_Info ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Inv_Inv_Info T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Inv_Inv_Info";
