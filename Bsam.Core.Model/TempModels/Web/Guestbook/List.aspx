<%@ Page Title="Guestbook" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Guestbook.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="blogId" HeaderText="blogId" SortExpression="blogId" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="body" HeaderText="body" SortExpression="body" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ip" HeaderText="ip" SortExpression="ip" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isshow" HeaderText="isshow" SortExpression="isshow" ItemStyle-HorizontalAlign="Center"  /> 
