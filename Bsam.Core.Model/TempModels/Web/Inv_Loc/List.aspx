<%@ Page Title="Inv_Loc" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Inv_Loc.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="LocCode" HeaderText="LocCode" SortExpression="LocCode" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LocName" HeaderText="LocName" SortExpression="LocName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LocDesc" HeaderText="LocDesc" SortExpression="LocDesc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LocStatus" HeaderText="LocStatus" SortExpression="LocStatus" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LocOrder" HeaderText="LocOrder" SortExpression="LocOrder" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Volume" HeaderText="Volume" SortExpression="Volume" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="VolumeUnit" HeaderText="VolumeUnit" SortExpression="VolumeUnit" ItemStyle-HorizontalAlign="Center"  /> 
