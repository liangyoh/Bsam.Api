...
namespace Bsam.Core.Model.Models.Web.ModulePermission
{
	...
	{
		Bsam.Core.Model.Models.BLL.ModulePermission bll=new Bsam.Core.Model.Models.BLL.ModulePermission();
		Bsam.Core.Model.Models.Model.ModulePermission model=bll.GetModel(Id);
