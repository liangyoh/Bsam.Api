<%@ Page Title="Sys_UserGroup" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sys_UserGroup.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="UserGroupName" HeaderText="UserGroupName" SortExpression="UserGroupName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UserGroupDesc" HeaderText="UserGroupDesc" SortExpression="UserGroupDesc" ItemStyle-HorizontalAlign="Center"  /> 
