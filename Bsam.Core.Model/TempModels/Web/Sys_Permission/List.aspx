<%@ Page Title="Sys_Permission" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sys_Permission.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="PermissionName" HeaderText="PermissionName" SortExpression="PermissionName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PermissionDesc" HeaderText="PermissionDesc" SortExpression="PermissionDesc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RequestType" HeaderText="RequestType" SortExpression="RequestType" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ClientType" HeaderText="ClientType" SortExpression="ClientType" ItemStyle-HorizontalAlign="Center"  /> 
