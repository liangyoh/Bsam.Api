<%@ Page Title="Sys_PermissionGroup" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sys_PermissionGroup.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="PermissionGroupName" HeaderText="PermissionGroupName" SortExpression="PermissionGroupName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PermissionGroupDesc" HeaderText="PermissionGroupDesc" SortExpression="PermissionGroupDesc" ItemStyle-HorizontalAlign="Center"  /> 
