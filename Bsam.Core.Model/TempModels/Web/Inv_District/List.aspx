<%@ Page Title="Inv_District" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Inv_District.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="DistrictCode" HeaderText="DistrictCode" SortExpression="DistrictCode" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="DistrictName" HeaderText="DistrictName" SortExpression="DistrictName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="DistrictDesc" HeaderText="DistrictDesc" SortExpression="DistrictDesc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="DistrictStatus" HeaderText="DistrictStatus" SortExpression="DistrictStatus" ItemStyle-HorizontalAlign="Center"  /> 
