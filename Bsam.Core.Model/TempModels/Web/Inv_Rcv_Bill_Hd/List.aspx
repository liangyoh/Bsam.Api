<%@ Page Title="Inv_Rcv_Bill_Hd" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Inv_Rcv_Bill_Hd.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="RcvType" HeaderText="RcvType" SortExpression="RcvType" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RcvUserId" HeaderText="RcvUserId" SortExpression="RcvUserId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RcvUserName" HeaderText="RcvUserName" SortExpression="RcvUserName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RcvPhone" HeaderText="RcvPhone" SortExpression="RcvPhone" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="RentSubject" HeaderText="RentSubject" SortExpression="RentSubject" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RentUserId" HeaderText="RentUserId" SortExpression="RentUserId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RentUserName" HeaderText="RentUserName" SortExpression="RentUserName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RentPhone" HeaderText="RentPhone" SortExpression="RentPhone" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RrcBillId" HeaderText="RrcBillId" SortExpression="RrcBillId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PlanRtnDateTime" HeaderText="PlanRtnDateTime" SortExpression="PlanRtnDateTime" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ActualRtnDateTime" HeaderText="ActualRtnDateTime" SortExpression="ActualRtnDateTime" ItemStyle-HorizontalAlign="Center"  /> 
