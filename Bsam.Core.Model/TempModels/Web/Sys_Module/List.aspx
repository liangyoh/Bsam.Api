<%@ Page Title="Sys_Module" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sys_Module.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ModuleType" HeaderText="ModuleType" SortExpression="ModuleType" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ModuleCode" HeaderText="ModuleCode" SortExpression="ModuleCode" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ModuleName" HeaderText="ModuleName" SortExpression="ModuleName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ModuleDesc" HeaderText="ModuleDesc" SortExpression="ModuleDesc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ModuleConfig" HeaderText="ModuleConfig" SortExpression="ModuleConfig" ItemStyle-HorizontalAlign="Center"  /> 
