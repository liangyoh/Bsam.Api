<%@ Page Title="Sys_User" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sys_User.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="UserAccount" HeaderText="UserAccount" SortExpression="UserAccount" ItemStyle-HorizontalAlign="Center"  /> 
