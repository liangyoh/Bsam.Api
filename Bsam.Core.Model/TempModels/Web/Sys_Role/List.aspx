<%@ Page Title="Sys_Role" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sys_Role.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="RoleDesc" HeaderText="RoleDesc" SortExpression="RoleDesc" ItemStyle-HorizontalAlign="Center"  /> 
