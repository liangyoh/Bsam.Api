<%@ Page Title="Inv_Rcv_Bill_Dtl" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Inv_Rcv_Bill_Dtl.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="BillId" HeaderText="BillId" SortExpression="BillId" ItemStyle-HorizontalAlign="Center"  /> 
