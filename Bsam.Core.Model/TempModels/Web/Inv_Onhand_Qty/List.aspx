<%@ Page Title="Inv_Onhand_Qty" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Inv_Onhand_Qty.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="LocId" HeaderText="LocId" SortExpression="LocId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Trans_Qty" HeaderText="Trans_Qty" SortExpression="Trans_Qty" ItemStyle-HorizontalAlign="Center"  /> 
