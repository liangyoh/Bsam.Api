...
namespace Bsam.Core.Model.Models.Web.Sfc_Customer
{
	...
	private void ShowInfo()
	{
		...
		this.txtCustomerShortName.Text=model.CustomerShortName;
		this.txtCustomerPhone.Text=model.CustomerPhone;
		this.txtCustomerWebchat.Text=model.CustomerWebchat;
		this.txtEnterpriseName.Text=model.EnterpriseName;
		this.txtEnterpriseLegal.Text=model.EnterpriseLegal;
		this.txtEnterpriseAddress.Text=model.EnterpriseAddress;
		this.txtEnterprisePhone.Text=model.EnterprisePhone;
