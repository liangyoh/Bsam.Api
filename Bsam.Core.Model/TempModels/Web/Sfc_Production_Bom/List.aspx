<%@ Page Title="Sfc_Production_Bom" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sfc_Production_Bom.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="MitemId" HeaderText="MitemId" SortExpression="MitemId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ReqQty" HeaderText="ReqQty" SortExpression="ReqQty" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Version" HeaderText="Version" SortExpression="Version" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="VersionDesc" HeaderText="VersionDesc" SortExpression="VersionDesc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BatchNo" HeaderText="BatchNo" SortExpression="BatchNo" ItemStyle-HorizontalAlign="Center"  /> 
