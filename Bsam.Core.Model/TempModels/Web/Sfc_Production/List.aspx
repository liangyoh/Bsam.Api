<%@ Page Title="Sfc_Production" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Bsam.Core.Model.Models.Web.Sfc_Production.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ProductCode" HeaderText="ProductCode" SortExpression="ProductCode" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ProductName" HeaderText="ProductName" SortExpression="ProductName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ProductDesc" HeaderText="ProductDesc" SortExpression="ProductDesc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ModelType" HeaderText="ModelType" SortExpression="ModelType" ItemStyle-HorizontalAlign="Center"  /> 
