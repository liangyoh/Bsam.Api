...
{
	/// <summary>
	/// Sys_PermissionGroup:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class Sys_PermissionGroup
	{
		...
		private string _permissiongroupdesc;
		...
		{
			set{ _permissiongroupname=value;}
			get{return _permissiongroupname;}
		}
		/// <summary>
		/// 
		/// </summary>
		public string PermissionGroupDesc
		{
			set{ _permissiongroupdesc=value;}
			get{return _permissiongroupdesc;}
		}
		/// <summary>
		/// 
		/// </summary>
